...
class LT_Dataset(Dataset):
    ...
    def __init__(self, root, txt, transform=None, unsup=False):
        self.img_path = []
        self.targets = []
    ...
    def __getitem__(self, index):
        ...
        if self.unsup:
            image1, image2 = self.loader(sample)
...
class ImageNet_LT(object):
    def __init__(self, distributed, root="", batch_size=60, num_works=40, unsup=False):
